...
const ProductImage = ({
  ...
  useEffect(() => {
    ...
    const preloadUrl = getOptimizedImageUrl(src, 280, Math.max(quality - 5, 10));
  ...
  const srcset = skipOptimization ? undefined : getResponsiveSrcset(src, [150, 220, 320, 480, 640], quality);
