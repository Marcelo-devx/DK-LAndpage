...
// Using centralized terms content from src/data/terms.ts
const CompleteProfilePage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-off-white p-4 relative overflow-hidden">
      ...
      <InformationalPopup isOpen={isTermsOpen} onClose={handleCloseTerms} title="Termo de Uso e Responsabilidade" content={TERMS_CONTENT} onAccept={() => { handleAcceptTerms(); handleCloseTerms(); }} />
    </div>
  );
};
